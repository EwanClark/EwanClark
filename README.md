...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=py,rust,cpp,js,ts,nextjs,react,tailwind,express,electron,supabase,mongodb,aws,git&theme=light)](https://skillicons.dev)
